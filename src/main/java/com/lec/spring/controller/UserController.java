...
public class UserController {
    ...
    public String registerOk(@Valid User user
        ...
        // 이미 등록된 중복된 아이디(username) 이 입력되면 // userService 매개변수로 넘겨서 validator 에서 아이디 중복 확인 가능
    ...
    public void initBinder(WebDataBinder binder) {
        binder.setValidator(new UserValidator()); // userService 매개변수로 넘겨서 validator 에서 아이디 중복 확인 가능
    }
